...
export IMAGE_URL=${IMAGE_URL-quay.io/rhtap_qe/go-fkoowjly:$CI_TYPE-$TAG}
...
export GITOPS_REPO_URL=https://github.com/rhtap-rhdh-qe/go-fkoowjly-gitops
...
export COSIGN_PUBLIC_KEY="LS0tLS1CRUdJTiBQVUJMSUMgS0VZLS0tLS0KTUZrd0V3WUhLb1pJemowQ0FRWUlLb1pJemowREFRY0RRZ0FFVXg3V3JENzBVVmZXWTVFaXplQnJOL1B1Y0lEOApQVnFjSHg4dkl3bFk4aHlCQ1dIaklubDY1YVFTdnJtUnY0Yk9xMWlGaFZFYnRscEFsOHh5ZUxVWWh3PT0KLS0tLS1FTkQgUFVCTElDIEtFWS0tLS0tCg=="
...
export REKOR_HOST=${REKOR_HOST-https://rekor-server-tssc-tas.apps.rosa.kx-660ac9fcce.tf5l.p3.openshiftapps.com}
...
export TUF_MIRROR=${TUF_MIRROR-https://tuf-tssc-tas.apps.rosa.kx-660ac9fcce.tf5l.p3.openshiftapps.com}
